...
from examples import io_utils, transform_utils, camera_utils
from pybullet_tools.utils import get_pose, get_relative_pose, link_from_name
...
class RGBDSensor:
    ...
    def get_state(self):
        ...
        h_world_robot = transform_utils.from_pose(*get_relative_pose(0, link_from_name(0, 'panda_hand'), link_from_name(0,'panda_link0')))
        # h_world_robot = transform_utils.from_pose(*get_pose(0))
    ...
    def _construct_camera(self, camera_info, transform):
        self.camera = RGBDCamera(camera_info)
